...
$mydir/returnn/tools/dump-dataset.py \
  "{'class':'CernCorpus', 'bpe':{'bpe_file':'trans.bpe.codes', 'vocab_file':'trans.bpe.vocab', 'unknown_label':'unk'}, 'path':'.', 'audio':{}, 'prefix': 'train', 'use_zip': False, 'seq_ordering':'random'}" \
  --endseq -1 --type null --dump_stats stats
