...
#CUDA_VISIBLE_DEVICES=2 ./returnn/rnn.py cased_cern_eu-until2020_ilo_itu_libri_unesco_unog_wipo-2012-2019.config
CUDA_VISIBLE_DEVICES=1 ./returnn/rnn.py fr_cv_euparl-st_euparlpost2018_ilo_unog.config
